...
export const WorkflowEditActionLogicFunction = ({
  ...
  const hasInputDiverged = useMemo(() => {
    const storedInput = action.settings.input.logicFunctionInput ?? {};

    return JSON.stringify(functionInput) !== JSON.stringify(storedInput);
    ...
    updateAction({
      ...
      settings: {
        ...
        input: {
          ...
          logicFunctionInput: functionInput,
        },
      },
    });
  }, [
